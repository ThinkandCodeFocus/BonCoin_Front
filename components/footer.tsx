        ...
        <div className="border-t border-background/10 dark:border-border/60">
          <div className="max-w-6xl mx-auto px-6 py-4 text-xs text-background/60 dark:text-muted-foreground flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="#" className="hover:text-accent transition-colors">Confidentialite</Link>
              <Link href="#" className="hover:text-accent transition-colors">Conditions generales</Link>
              <Link href="#" className="hover:text-accent transition-colors">Aide</Link>
            </div>
          </div>
        </div>
      </div>
